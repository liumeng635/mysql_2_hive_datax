...
public class RemoteShellTool {
     ...
     private final static String DATAX_REMOTE_PATH=PropertiesUtil.getDataParam("datax.remote.path");
     private final static String HADOOP_DFS_PATH=PropertiesUtil.getDataParam("hadoop.dfs.path");
     /*
      * 加载配置信息
      */
     static{
